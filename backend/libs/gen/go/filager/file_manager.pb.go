...
var file_filager_file_manager_proto_rawDesc = string([]byte{
...
var (
	...
	file_filager_file_manager_proto_rawDescData []byte
)

func file_filager_file_manager_proto_rawDescGZIP() []byte {
	file_filager_file_manager_proto_rawDescOnce.Do(func() {
		file_filager_file_manager_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_filager_file_manager_proto_rawDesc), len(file_filager_file_manager_proto_rawDesc)))
	})
...
var file_filager_file_manager_proto_goTypes = []any{
...
func file_filager_file_manager_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_filager_file_manager_proto_rawDesc), len(file_filager_file_manager_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
